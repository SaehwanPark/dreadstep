...
Dreadstep is beginning Milestone 2: the agent interface. The active slice adds session history
and deterministic replay digest evidence to the in-memory MCP player session; legal actions,
