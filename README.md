...
Dreadstep is beginning Milestone 2: the agent interface. The active slice names the read-only
tester `inspect_world` projection over the complete protocol snapshot; in-memory tester
