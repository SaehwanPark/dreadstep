...
Dreadstep is continuing Milestone 2: the agent interface. The active slice adds read-only accepted
history to the local MCP stdio server; actor inspection, legal-action discovery, typed player actions, minimal observation, validated tester
