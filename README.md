...
- Active presentation boundary: caller-selected logical tile extents now project checked pixel
  origins onto terrain, actor, and ground-item mirrors without choosing a tile size or enabling
  rendering.
