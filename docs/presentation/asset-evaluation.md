...
are explicit. The mixed fallback still requires a reversible headless-to-renderer spike before any
ignored binary is loaded by Bevy or treated as canonical game content.
