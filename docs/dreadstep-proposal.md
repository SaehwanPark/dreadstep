...
- The active ECS Sprite-depth boundary derives deterministic terrain/ground/actor z-layer values
  from typed render order while preserving checked x/y placement and inventory default state;
