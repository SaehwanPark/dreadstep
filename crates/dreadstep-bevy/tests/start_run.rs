...
fn item_run_startup_projects_complete_inventory_scene() {
  ...
  assert_eq!(world.query::<&SceneInventoryItem>().iter(world).count(), 7);
  ...
  assert_eq!(
    ...
    BTreeMap::from([
      ...
      (
        ItemId::new(106),
        (ActorId::new(2), ItemDefinitionId::new(7), 2),
      ),
      (
        ItemId::new(101),
      ...
      (
        ItemId::new(102),
        (ActorId::new(1), ItemDefinitionId::new(3), 3),
      ),
      (
        ItemId::new(103),
        (ActorId::new(1), ItemDefinitionId::new(4), 1),
      ),
      (
        ItemId::new(104),
        (ActorId::new(1), ItemDefinitionId::new(5), 2),
      ),
    ])
  );
